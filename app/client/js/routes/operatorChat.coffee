...
"helpers/embedImageIfExists", "helpers/chatActions", 'helpers/sidebarHelpers', 'components/operatorChat'],
  (server, pulsar, notify, controls, chatMessage, serverMessage, badge, util, wireUpChatAppender, embedImage, chatActions, {readChat, getUnread}, operatorChat) ->
    channels: []
    setup:
      (args, templ, query) ->
        self = this
