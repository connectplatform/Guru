...
(function() {
  ...
  define(["app/server", "app/pulsar", "app/notify", "routes/chatControls", "templates/chatMessage", "templates/serverMessage", "templates/badge", "js/util"], function(server, pulsar, notify, controls, chatMessage, serverMessage, badge, util) {
    return function(args, templ) {
      ...
      return server.ready(function(services) {
        return server.getMyChats(function(err, chats) {
          var channel, chat, createChatAppender, createChatRemover, createSubmitHandler, ran, updateChatBadge, _i, _j, _k, _len, _len1, _len2, _results;
