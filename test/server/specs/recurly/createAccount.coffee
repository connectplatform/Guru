...
boiler 'Recurly - Create Account', ->
  ...
  describe 'with valid data', ->
    beforeEach (done) ->
      @createRecurlyAccount {accountId: @account._id, owner: @ownerUser}, (err, @result) =>
  ...
  describe 'with duplicate accountId', ->
    it 'should return error', (done) ->
      @createRecurlyAccount {accountId: @account._id, owner: @ownerUser}, =>
        @createRecurlyAccount {accountId: @account._id, owner: @ownerUser}, (err, @result) =>
  ...
  describe 'with invalid data', ->
    it 'should return error', (done) ->
      @createRecurlyAccount {accountId: 'foo', owner: @ownerUser}, (err, @result) =>
