...
module.exports = (res, userData) ->
  ...
  getAvailableOperators website, department, (err, accountId, operators) ->
    if err
      errData = {error: err, website: website, department: department, operators: operators}
      ...
      async.parallel tasks, (err) ->
        if err
          errData = {
            ...
            website: website, department: department
          }
