(function() {
  ...
  define(["load/server", "load/pulsar", "load/notify", "templates/newChat", "templates/chatMessage", "templates/serverMessage", "helpers/wireUpChatAppender", "templates/websiteLogo"], function(server, pulsar, notify, newChat, chatMessage, serverMessage, wireUpChatAppender, logoTemplate) {
    return {
      channel: {},
