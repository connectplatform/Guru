...
(function() {
  ...
  define("dermis", function(jade, View) {
    var dermis, getBaseUrl, parseQueryString;
    getBaseUrl = function(longUrl) {
      var queryIndex, url, _ref, _ref2;
      queryIndex = longUrl.indexOf('?');
      url = (queryIndex === -1 ? longUrl : longUrl.slice(0, queryIndex));
      if (url === '/') {
        return 'index';
      } else {
        return ((_ref = /\/(.*?)\//.exec(url)) != null ? _ref[1] : void 0) || ((_ref2 = /\/(.*)/.exec(url)) != null ? _ref2[1] : void 0);
      }
    };
    parseQueryString = function(query) {
      var decode, match, pl, queryParams, search;
      queryParams = {};
      match = void 0;
      pl = /\+/g;
      search = /([^&=]+)=?([^&]*)/g;
        ...
        setup = function(routeArguments, queryString) {
          return require([service, view], function(srv, tmpl) {
            if (typeof srv === 'function') {
              ...
              return srv.setup(routeArguments, tmpl, parseQueryString(queryString));
            }
          });
        };
        ...
        for (_i = 0, _len = urls.length; _i < _len; _i++) {
          ...
          _results.push((function() {
            ...
            for (_j = 0, _len2 = filters.length; _j < _len2; _j++) {
              filter = filters[_j];
              _results2.push(rooter.addBeforeFilter(url, filter));
            }
            return _results2;
          })());
        }
