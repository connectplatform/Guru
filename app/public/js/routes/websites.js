(function() {
  ...
  define(["load/server", "load/notify", "templates/editWebsite", "templates/deleteWebsite", "templates/websiteRow", "helpers/formBuilder"], function(server, notify, editWebsite, deleteWebsite, websiteRow, formBuilder) {
